...
#### no API 模块化短路径还未实现，有会的，联系我 mr_hao918512@126.com

* [参考](http://csspod.com/using-browserify-with-gulp/)
* [参考](https://github.com/gulpjs/gulp/blob/master/docs/recipes/browserify-with-globs.md)
